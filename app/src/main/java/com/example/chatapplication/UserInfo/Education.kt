...
fun YourEducation(
    ...
    Scaffold(
        floatingActionButton = {
            BottomNavigationButton(navController = navController, route = "DoYouWantKids")
        }
    ) { innerPadding ->
        Column(
            modifier = Modifier
            ...
            Button(
                onClick = {
                    ...
                    navController.navigate("DoYouWantKids") // Navigate to login on click
                },
                modifier = Modifier
                    .fillMaxWidth(0.8f)
                    .padding(bottom = 8.dp),
...
@Composable
fun previewDoYourEducation() {
    YourEducation(navController = rememberNavController())
